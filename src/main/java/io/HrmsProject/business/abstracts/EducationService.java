...
public interface EducationService extends BaseEntityService<Education, CreateEducationRequests, UpdateEducationRequests, GetAllEducationResponses,GetByIdEducationResponse>{
