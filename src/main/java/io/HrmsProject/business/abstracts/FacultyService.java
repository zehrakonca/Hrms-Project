...
public interface FacultyService extends BaseEntityService<Faculty, CreateFacultyRequests, UpdateFacultyRequests, GetAllFacultyResponse,GetByIdFacultyResponse>{
